...
تمت إزالة المسافات غير الضرورية باستخدام TRIM، وحذف 17 صفاً مكرراً، وتنسيق البيانات لتكون أكثر وضوحًا.
...
[Raghad's LinkedIn](https://www.linkedin.com/in/USERNAME)

> 🟥 استبدلي `USERNAME` باسم المستخدم الخاص برغد على لينكدإن.
